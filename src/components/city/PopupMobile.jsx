...
const Popup = ({ onClose }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // Überprüfen, ob die Zustimmung gegeben wurde
    if (!consent) {
      setError('Bitte stimmen Sie zu, dass wir Sie kontaktieren dürfen.');
      return;
    }
    ...
    emailjs
      .send(
        'YOUR_SERVICE_ID', // Ersetzen Sie dies durch Ihre EmailJS Service ID
        'YOUR_TEMPLATE_ID', // Ersetzen Sie dies durch Ihre EmailJS Template ID
        templateParams,
        'YOUR_PUBLIC_KEY' // Ersetzen Sie dies durch Ihren EmailJS Public Key
      )
      .then((response) => {
  ...
  return (
    <div id="over" className="popup-overlay" onClick={handlePopupClick}>
      <div
        id="pop"
        className="fixed bottom-0 z-50 p-4 mx-4 bg-white rounded-lg border border-gray-200 shadow sm:bottom-6 md:p-6 pos newsletter-pop-up"
      >
