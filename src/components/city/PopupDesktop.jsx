...
const Popup = ({ onClose }) => {
  ...
  return (
    <div id="over" className="popup-overlay">
      <div id="pop" className="fixed bottom-0 z-50 p-4 mx-4 bg-white rounded-lg border border-gray-200 shadow  sm:bottom-6md:p-6 pos newsletter-pop-up">
        ...
        <form action="#">
          ...
          <div>
            <button
              ...
              rounded-lg cursor-pointer bg-blue-700 hover:bg-blue-800
